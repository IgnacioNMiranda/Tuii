...
=======
  ('sum_function -> SUM LP id RP PC','sum_function',5,'p_sum_function','Tuii.py',200),
  ('operator_plus_minus -> MAS','operator_plus_minus',1,'p_operator_plus_minus','Tuii.py',208),
  ('operator_plus_minus -> MENOS','operator_plus_minus',1,'p_operator_plus_minus','Tuii.py',209),
  ('operator_mul_div -> MUL','operator_mul_div',1,'p_operator_mul_div','Tuii.py',217),
  ('operator_mul_div -> DIV','operator_mul_div',1,'p_operator_mul_div','Tuii.py',218),
  ('single_op -> ID IGUAL term PC','single_op',4,'p_single_op','Tuii.py',226),
  ('print -> PRINT LP id RP PC','print',5,'p_print','Tuii.py',234),
  ('print -> PRINT LP TEXT RP PC','print',5,'p_print','Tuii.py',235),
  ('if_stmt -> IF LP ID RP LK sentence RK','if_stmt',7,'p_if_stmt','Tuii.py',243),
  ('if_stmt -> IF LP ID RP LK sentence RK ELSE LK sentence RK','if_stmt',11,'p_if_stmt','Tuii.py',244),
  ('id -> ID','id',1,'p_id','Tuii.py',255),
>>>>>>> Stashed changes
]
